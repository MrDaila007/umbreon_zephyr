...
LOG_MODULE_DECLARE(VL53L0X_ENH, CONFIG_SENSOR_LOG_LEVEL);
...
{
	ARG_UNUSED(Dev);
#if CONFIG_VL53L0X_ENHANCED_ST_POLLING_DELAY_MS > 0
	k_sleep(K_MSEC(CONFIG_VL53L0X_ENHANCED_ST_POLLING_DELAY_MS));
#endif
