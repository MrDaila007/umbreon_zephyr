...
/* Display uses dedicated i2c_oled bus — no mutex needed */
...
static const struct param_desc params[] = {
	...
	{"KOP", "Kick %",     PT_FLOAT, 0.5f, 2.0f, 0, 50.0f, P_OFF(kick_pct),           1},
	{"KOM", "Kick ms",    PT_INT,   10,  50,    0, 2000,  P_OFF(kick_ms),             1},
